...
<h3> Real time Covid emergency alarming system- using wireless sensor network  </h3>
</td>
</tr>
</table>
</div>
...
{
if($_REQUEST['user'] == "health" && $_REQUEST['pwd'] == "health456")
{
$_SESSION['user'] = array("username" => "health", "password" => "health456");
